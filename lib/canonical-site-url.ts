const productionOrigin = "https://www.devilhena.com";
...
export function getCanonicalCheckoutOrigin() {
  ...
  if (url.origin !== productionOrigin || url.protocol !== "https:" || url.hostname !== "www.devilhena.com" || url.pathname !== "/" || url.search || url.hash || url.username || url.password) {
